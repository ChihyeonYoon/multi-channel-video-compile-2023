...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_ch0_path', type=str, default=f'compile_materials/opentalk/camera1_synced.mp4',
                        help='video ch0 path')
    parser.add_argument('--video_ch1_path', type=str, default=f'compile_materials/opentalk/camera1_synced.mp4',
                        help='video ch1 path')
    parser.add_argument('--video_ch2_path', type=str, default=f'compile_materials/opentalk/camera1_synced.mp4',
                        help='video ch2 path')
    ...
    audio = audio.subclip(t_start = start_time, t_end = end_time)
    output_video_with_audio = output_video_with_audio.set_audio(audio)
    output_video_with_audio.write_videofile(args.output_video_path.replace('.mp4','_version2.mp4'), codec='libx264', audio_codec='aac')
